...
const std::map<char, std::pair<sf::Color, sf::Color>> Palette::colors = {
    {'*', {sf::Color(0xbdbdbdff), sf::Color(0x8d8d8dff)}},
    {'0', {sf::Color(0xec407aff), sf::Color(0xb4004eff)}},
    {'1', {sf::Color(0x9c27b0ff), sf::Color(0x6a0080ff)}},
    {'2', {sf::Color(0x00bcd4ff), sf::Color(0x008ba3ff)}},
    {'3', {sf::Color(0x009688ff), sf::Color(0x00675bff)}},
    {'4', {sf::Color(0x4caf50ff), sf::Color(0x087f23ff)}},
    {'5', {sf::Color(0x607d8bff), sf::Color(0x34515eff)}},
    {'6', {sf::Color(0x8d6e63ff), sf::Color(0x5f4339ff)}},
    {'7', {sf::Color(0xc62828ff), sf::Color(0x8e0000ff)}},
    {'!', {sf::Color(0x2196f3ff), sf::Color(0x0069c0ff)}}};

Palette::Palette() : unit(window.getSize().y / 15.f),
