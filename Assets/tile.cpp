...
Tile::Tile(char newData, const sf::Vector2f &newPosition) : shapes(3, sf::ConvexShape(4)),
                                                            data(newData),
...
Initializable_tile::Initializable_tile(char newData, const sf::Vector2f &newPosition) : Tile(newData, newPosition)

{
    this->setShape(newData);
}

Non_initializable_tile::Non_initializable_tile(char newData, const sf::Vector2f &newPosition) : Tile(newData, newPosition),
                                                                                                crossShape{
...
Void_tile::Void_tile(char newData, const sf::Vector2f &newPosition) : Tile(newData, newPosition)
